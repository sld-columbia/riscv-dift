...
int my_main (int argc, char **argv) {
  ...
  if (argc < 2 || atoi(argv[1]) < -4 || atoi(argv[1]) > 20) {
    ...
    printf("-4 =  Target: Parameter function pointer\n");
    printf("-3 =  Target: Parameter longjmp buffer\n");
    printf(" 1 =  Target: Return address\n");
    printf(" 2 =  Target: Old base pointer\n");
    printf(" 3 =  Target: Function pointer\n");
    printf(" 4 =  Target: Longjmp buffer\n");
    printf("\nBuffer overflow on BSS all the way to the target\n");
    printf(" 5 =  Target: Function pointer\n");
    printf(" 6 =  Target: Longjmp buffer\n");
    printf("\nBuffer overflow of pointer on STACK and then pointing to target\n");
    printf("-2 =  Target: Parameter function pointer\n");
    printf("-1 =  Target: Parameter longjmp buffer\n");
    printf(" 7 =  Target: Return address\n");
    printf(" 8 =  Target: Old base pointer\n");
    printf(" 9 =  Target: Function pointer\n");
    printf("10 = Target: Longjmp buffer\n");
    printf("\nBuffer overflow of pointer on BSS and then pointing to target\n");
    printf("11 =  Target: Return address\n");
    printf("12 =  Target: Old base pointer\n");
    printf("13 =  Target: Function pointer\n");
    printf("14 =  Target: Longjmp buffer\n\n");
    printf("\nBuffer overflow of pointer on HEAP and then pointing to target\n");
    printf("15 =  Target: Return address\n");
    printf("16 =  Target: Old base pointer\n");
    printf("17 =  Target: Function pointer\n");
    printf("18 =  Target: Longjmp buffer\n\n");
    printf("\nBuffer overflow on HEAP all the way to the target\n");
    printf("19 =  Target: Function pointer\n");
    printf("20 =  Target: Longjmp buffer\n\n");
    printf("Optional base pointer offset = number of bytes inbetween return address and base pointer on stack (used with canary values).\n\n");
    exit(-1); }
